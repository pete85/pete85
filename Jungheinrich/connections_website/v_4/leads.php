...
<section class="container main-body margin-top-100">
	...
	<h1>Submitted leads</h1>
		...
		<div class="row filters">
			...
			<div class="col-sm-3">
				<h3>Enquiry type</h3>
		      	<input type="text" id="filter-enquiry" onkeyup="filterEnquiry()" placeholder="Enquiry type...">
			</div>
			<div class="col-sm-3">
				<h3>Product</h3>
		      	<input type="text" id="filter-product" onkeyup="filterProduct()" placeholder="Product...">
			</div>
			<div class="col-sm-3">
				<h3>Lead from</h3>
				<input type="text" id="filter-source" onkeyup="filterSource()" placeholder="Name...">
			</div>
			<div class="col-sm-3">
				<h3>Sales contact</h3>
				<input type="text" id="filter-contact" onkeyup="filterContact()" placeholder="Name...">
			</div>
		</div>
