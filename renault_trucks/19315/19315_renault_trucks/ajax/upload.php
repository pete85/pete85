...
$message = "<p>Name: ". $name  . "</p>" . "<p>Email: ". $email_from  . "</p>" . "<p>Telephone: ". $tel  . "</p>" . "<p>File: ". '<a href="http://www.proudprofessionals.co.uk/dev/uploads/' . $handle->file_dst_name . '">' . $handle->file_dst_name . '</a></p>';
...
mail($to, $subject, $message, $headers);
		...
		$to      = 'patrick@stream-ltd.com';
			...
			$email_from = $_POST["uploademail"];
			$tel = $_POST["uploadtel"];
			$uploadyt = $_POST["uploadyt"];
	
	
$message = "<p>Name: ". $name  . "</p>" . "<p>Email: ". $email_from  . "</p>" . "<p>Telephone: ". $tel  . "</p>" . "<p>Youtube: " . $uploadyt . "</p>";
$headers = 'From: noreply@proudprofessionals.co.uk' . "\r\n" . 'X-Mailer: PHP/' . phpversion();
$headers .= "MIME-Version: 1.0\r\n";
$headers .= "Content-Type: text/html; charset=ISO-8859-1\r\n";
